...
export const ProfileView: React.FC<Readonly<ProfileViewProps>> = ({ user, listings, isOwnProfile, onEditSettings, onListingClick }) => {
      ...
      >
        <ListingsGrid
          listings={listings.map((l) => ({
            ...
            state: ["Published", "Paused", "Cancelled", "Drafted", "Expired", "Blocked", "Appeal Requested"].includes(l.state)
              ? (l.state as "Published" | "Paused" | "Cancelled" | "Drafted" | "Expired" | "Blocked" | "Appeal Requested" | undefined)
              : undefined,
