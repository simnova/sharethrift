...
import type { CurrentUserQueryData, UserListingsQueryData, UserListing } from "./profile-view.types.ts";
import {
...
function ProfileViewLoader() {
  ...
  const userListings =
    listingsData?.itemListings?.filter((listing: UserListing & { sharer: string; updatedAt: string }) => {
