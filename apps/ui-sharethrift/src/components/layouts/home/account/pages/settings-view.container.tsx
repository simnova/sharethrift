...
import type { CurrentUserSettingsQueryData, SettingsUser } from './settings-view.types';
import { HomeAccountSettingsViewContainerCurrentUserDocument } from '../../../../../generated';
...
function SettingsViewLoader() {
  const {
    ...
    loading: userLoading,
    error: userError
  } = useQuery<CurrentUserSettingsQueryData>(HomeAccountSettingsViewContainerCurrentUserDocument);
