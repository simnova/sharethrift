...
import type { PaymentContainerAccountPlansFieldsFragment, ProcessPaymentInput } from "../../../../generated";
...
export const Payment: FC<PaymentProps> = (props) => {
  const additionalPaymentContent = (
    <>
      ...
      >
        <Text style={{ color: "var(--color-message-text)", fontSize: "16px" }}>{props.selectedAccountPlan.description}</Text>
        <Text
          style={{
        ...
        >
          ${props.selectedAccountPlan.billingAmount}/{props.selectedAccountPlan.billingPeriodUnit}
        </Text>
      </div>
      <Form.Item
