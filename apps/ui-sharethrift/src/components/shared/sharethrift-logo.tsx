/**
 * ShareThrift brand logo component
 * Reusable SVG logo for use across the application
 */

interface ShareThriftLogoProps {
	/** Size of the logo in pixels (default: 24) */
	size?: number;
	/** Fill color for the logo (default: 'var(--color-foreground-1)') */
	fill?: string;
...
/**
 * ShareThrift brand logo SVG component
 * @param props - The component props
 * @returns JSX element containing the ShareThrift logo
 */
export const ShareThriftLogo: React.FC<ShareThriftLogoProps> = ({
	size = 24,
