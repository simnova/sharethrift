		...
		StartedApplication<ContextType>
{
	...
	>(
		...
		this.ensurePhase('app-services', 'handlers');
		// Type erasure: TFactory is compatible with RequestScopedHost<AppServices, unknown> by constraint
		// This widening is safe because the handler will receive the actual appServicesHostInternal at runtime
