...
import { createAuthHeader, type CreateAuthHeaderCommand, type CreateAuthHeaderResult } from './create-auth-header.ts';
...
export interface PersonalUserApplicationService {
    ...
    createAuthHeader: (
        command: CreateAuthHeaderCommand,
...
export const PersonalUser = (
    ...
    return {
        ...
        createAuthHeader: createAuthHeader(dataSources),
    };
};
