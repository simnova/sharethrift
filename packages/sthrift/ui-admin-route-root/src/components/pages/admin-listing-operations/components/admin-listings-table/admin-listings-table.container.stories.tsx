...
import { withMockApolloClient,withMockRouter } from '@sthrift/ui-admin-route-root/test-utils';
...
const meta: Meta<typeof AdminListings> = {
	...
	decorators: [withMockApolloClient, withMockRouter('/account/admin-listing-operations')],
};
