...
export function MessageSharerButton({ listingId, sharerId, className = '' }: MessageSharerButtonProps) {
  ...
  return (
    ...
    >
      {isCreating ? (
        ...
        <>
          <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-label="Message icon" role="img">
            <title>Message</title>
