...
type AdminListingTableRow = ComponentProps<
	typeof AdminListingsTable
>['data'][number];
		...
		data: [
			{
				id: mockListings[0]?.id ?? '1',
				title:
					'Very Long Listing Title That Should Be Displayed Properly In The Table Without Breaking The Layout',
