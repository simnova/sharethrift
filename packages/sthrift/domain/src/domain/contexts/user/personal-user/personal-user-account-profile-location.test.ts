...
const feature = await loadFeature(
	path.resolve(__dirname, 'features/personal-user-account-profile-location.feature'),
);

// biome-ignore lint/suspicious/noExplicitAny: Test helper function
function makeLocationProps(overrides?: Partial<PersonalUserAccountProfileLocationProps>): any {
	return {
...
test.for(feature, ({ Scenario }) => {
	Scenario('Location value object can be created with valid props', ({ Given, When, Then }) => {
	...
	Scenario('Location address1 getter returns correct value', ({ Given, When, Then }) => {
		let location: PersonalUserAccountProfileLocation;
		let value: string;
	...
	Scenario('Location address2 getter returns correct value', ({ Given, When, Then }) => {
		let location: PersonalUserAccountProfileLocation;
	...
	Scenario('Location city getter returns correct value', ({ Given, When, Then }) => {
		let location: PersonalUserAccountProfileLocation;
		let value: string;
	...
	Scenario('Location state getter returns correct value', ({ Given, When, Then }) => {
		let location: PersonalUserAccountProfileLocation;
		let value: string;
	...
	Scenario('Location country getter returns correct value', ({ Given, When, Then }) => {
		let location: PersonalUserAccountProfileLocation;
		let value: string;
	...
	Scenario('Location zipCode getter returns correct value', ({ Given, When, Then }) => {
		let location: PersonalUserAccountProfileLocation;
		let value: string;
	...
	Scenario('Location address1 setter requires valid visa', ({ Given, When, Then }) => {
		let location: PersonalUserAccountProfileLocation;
	...
	Scenario('Location address1 setter works with valid visa', ({ Given, When, Then }) => {
		let location: PersonalUserAccountProfileLocation;
	...
	Scenario('Location allows setters when entity is new', ({ Given, When, Then }) => {
		let location: PersonalUserAccountProfileLocation;
