...
test.for(feature, ({ Scenario }) => {
	...
	Scenario('Creating SystemPassport and accessing user passport', ({ Given, When, And, Then }) => {
	...
	Scenario('Creating SystemPassport and accessing listing passport', ({ Given, When, And, Then }) => {
		// biome-ignore lint/suspicious/noExplicitAny: Test variable
	...
	Scenario('Creating SystemPassport and accessing conversation passport', ({ Given, When, And, Then }) => {
		// biome-ignore lint/suspicious/noExplicitAny: Test variable
		...
		Then('it should return a SystemConversationPassport instance initialized with those permissions', () => {
			expect(conversationPassport1).toBeInstanceOf(SystemConversationPassport);
		});
	...
	Scenario('Creating SystemPassport and accessing reservation request passport', ({ Given, When, And, Then }) => {
		// biome-ignore lint/suspicious/noExplicitAny: Test variable
		...
		Then('it should return a SystemReservationRequestPassport instance initialized with those permissions', () => {
			expect(reservationPassport1).toBeInstanceOf(SystemReservationRequestPassport);
		});
