...
test.for(feature, ({ Scenario }) => {
	Scenario(
		'System passport for listing appeal request should use permission function',
		({ Given, When, Then }) => {
	...
	Scenario(
		'System passport for user appeal request should use permission function',
		({ Given, When, Then }) => {
			let passport: SystemAppealRequestPassport;
			// biome-ignore lint/suspicious/noExplicitAny: Test mock
			let visa: any;
	...
	Scenario(
		'System passport should extend SystemPassportBase',
		({ Given, When, Then }) => {
			let passport: SystemAppealRequestPassport;
