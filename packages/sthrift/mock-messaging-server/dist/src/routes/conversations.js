...
export function setupConversationRoutes(router) {
    ...
    router.get('/v1/Conversations/:conversationId', (req, res) => {
        try {
    ...
    router.post('/v1/Conversations/:conversationId', (req, res) => {
        try {
            const { conversationId } = req.params;
    ...
    router.delete('/v1/Conversations/:conversationId', (req, res) => {
        try {
            const { conversationId } = req.params;
