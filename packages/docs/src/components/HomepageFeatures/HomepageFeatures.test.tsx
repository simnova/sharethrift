...
describe('HomepageFeatures', () => {
	...
	it('renders feature descriptions', () => {
		...
		expect(
			screen.getByText(/Sharethrift implements sophisticated DDD patterns/),
		).toBeInTheDocument();
		expect(
			screen.getByText(/Focus on your business domains/),
		).toBeInTheDocument();
		expect(
			screen.getByText(/Full-stack TypeScript monorepo/),
		).toBeInTheDocument();
	});
