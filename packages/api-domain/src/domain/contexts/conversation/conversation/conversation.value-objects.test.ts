...
describeFeature(feature, ({ Scenario }) => {
	...
	// UserId
	Scenario('Creating a UserId with valid value', ({ When, Then }) => {
		let value: string;
		When('I create a UserId with "user-123"', () => {
			value = new ValueObjects.UserId('user-123').valueOf();
		});
	...
	Scenario(
		'Creating a UserId with leading and trailing whitespace',
		({ When, Then }) => {
			let value: string;
			When('I create a UserId with "  user-123  "', () => {
				value = new ValueObjects.UserId('  user-123  ').valueOf();
	...
	Scenario('Creating a UserId with too short value', ({ When, Then }) => {
		let createShort: () => void;
		When('I try to create a UserId with an empty string', () => {
			createShort = () => new ValueObjects.UserId('').valueOf();
		});
	...
	Scenario('Creating a UserId with too long value', ({ When, Then }) => {
		let createLong: () => void;
		When('I try to create a UserId with a string of 51 characters', () => {
			createLong = () => new ValueObjects.UserId('u'.repeat(51)).valueOf();
		});
		Then('an error should be thrown indicating the value is too long', () => {
			expect(createLong).throws('Too long');
		});
	...
	Scenario('Creating a UserId with null', ({ When, Then }) => {
		let createNull: () => void;
		When('I try to create a UserId with null', () => {
			createNull = () => {
				// @ts-expect-error
				new ValueObjects.UserId(null).valueOf();
			};
		});
		Then('an error should be thrown indicating the value is invalid', () => {
			expect(createNull).throws(/Wrong raw value type/i);
	...
	// ListingId
	Scenario('Creating a ListingId with valid value', ({ When, Then }) => {
		let value: string;
		When('I create a ListingId with "listing-123"', () => {
			value = new ValueObjects.ListingId('listing-123').valueOf();
		});
		Then('the value should be "listing-123"', () => {
			expect(value).toBe('listing-123');
		});
	});

	Scenario(
		'Creating a ListingId with leading and trailing whitespace',
		({ When, Then }) => {
			let value: string;
			When('I create a ListingId with "  listing-123  "', () => {
				value = new ValueObjects.ListingId('  listing-123  ').valueOf();
	...
	Scenario('Creating a ListingId with too short value', ({ When, Then }) => {
		let createShort: () => void;
		When('I try to create a ListingId with an empty string', () => {
			createShort = () => new ValueObjects.ListingId('').valueOf();
		});
		Then('an error should be thrown indicating the value is too short', () => {
			expect(createShort).throws('Too short');
		});
	...
	Scenario('Creating a ListingId with too long value', ({ When, Then }) => {
		let createLong: () => void;
		When('I try to create a ListingId with a string of 51 characters', () => {
			createLong = () => new ValueObjects.ListingId('l'.repeat(51)).valueOf();
		});
		Then('an error should be thrown indicating the value is too long', () => {
			expect(createLong).throws('Too long');
		});
	...
	Scenario('Creating a ListingId with null', ({ When, Then }) => {
		let createNull: () => void;
		When('I try to create a ListingId with null', () => {
			createNull = () => {
				// @ts-expect-error
				new ValueObjects.ListingId(null).valueOf();
			};
		});
		Then('an error should be thrown indicating the value is invalid', () => {
			expect(createNull).throws(/Wrong raw value type/i);
