...
export type ResolversTypes = ResolversObject<{
	...
	MongoBase: ResolverTypeWrapper<
		ResolversInterfaceTypes<ResolversTypes>['MongoBase']
	>;
	MongoSubdocument: ResolverTypeWrapper<
		ResolversInterfaceTypes<ResolversTypes>['MongoSubdocument']
	>;
	Mutation: ResolverTypeWrapper<{}>;
	MutationResult: ResolverTypeWrapper<
		ResolversInterfaceTypes<ResolversTypes>['MutationResult']
	>;
...
export type BlobAuthHeaderResolvers<
	ContextType = GraphContext,
	ParentType extends
		ResolversParentTypes['BlobAuthHeader'] = ResolversParentTypes['BlobAuthHeader'],
> = ResolversObject<{
	authHeader?: Resolver<
	...
	indexTags?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['BlobIndexTag']>>>,
		ParentType,
		ContextType
	>;
	metadataFields?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['BlobMetadataField']>>>,
		ParentType,
		ContextType
	>;
...
export type BlobIndexTagResolvers<
	ContextType = GraphContext,
	ParentType extends
		ResolversParentTypes['BlobIndexTag'] = ResolversParentTypes['BlobIndexTag'],
> = ResolversObject<{
...
export type BlobMetadataFieldResolvers<
	ContextType = GraphContext,
	ParentType extends
		ResolversParentTypes['BlobMetadataField'] = ResolversParentTypes['BlobMetadataField'],
> = ResolversObject<{
	name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
	value?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
	__isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type ItemListingResolvers<
	ContextType = GraphContext,
	ParentType extends
		ResolversParentTypes['ItemListing'] = ResolversParentTypes['ItemListing'],
> = ResolversObject<{
	...
	sharingHistory?: Resolver<
		Maybe<Array<ResolversTypes['String']>>,
		ParentType,
		ContextType
	>;
	sharingPeriodEnd?: Resolver<
		ResolversTypes['DateTime'],
		ParentType,
		ContextType
	>;
	sharingPeriodStart?: Resolver<
		ResolversTypes['DateTime'],
		ParentType,
		ContextType
	>;
	state?: Resolver<
		Maybe<ResolversTypes['ItemListingState']>,
		ParentType,
		ContextType
	>;
...
export type ListingResolvers<
	ContextType = GraphContext,
	ParentType extends
		ResolversParentTypes['Listing'] = ResolversParentTypes['Listing'],
> = ResolversObject<{
	id?: Resolver<ResolversTypes['ObjectID'], ParentType, ContextType>;
	__isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type MongoBaseResolvers<
	ContextType = GraphContext,
	ParentType extends
		ResolversParentTypes['MongoBase'] = ResolversParentTypes['MongoBase'],
> = ResolversObject<{
	__resolveType: TypeResolveFn<
		'Conversation' | 'ItemListing' | 'PersonalUser',
		ParentType,
		ContextType
	>;
	createdAt?: Resolver<
...
export type MongoSubdocumentResolvers<
	ContextType = GraphContext,
	ParentType extends
		ResolversParentTypes['MongoSubdocument'] = ResolversParentTypes['MongoSubdocument'],
> = ResolversObject<{
...
> = ResolversObject<{
	...
	cancelReservation?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationCancelReservationArgs, 'input'>
	>;
	closeReservation?: Resolver<
		ResolversTypes['ReservationRequest'],
		ParentType,
		ContextType,
		RequireFields<MutationCloseReservationArgs, 'input'>
	>;
	createItemListing?: Resolver<
		ResolversTypes['ItemListing'],
		ParentType,
		ContextType,
		RequireFields<MutationCreateItemListingArgs, 'input'>
	>;
}>;
...
export type MutationResultResolvers<
	ContextType = GraphContext,
	ParentType extends
		ResolversParentTypes['MutationResult'] = ResolversParentTypes['MutationResult'],
> = ResolversObject<{
	__resolveType: TypeResolveFn<
...
export type MutationStatusResolvers<
	ContextType = GraphContext,
	ParentType extends
		ResolversParentTypes['MutationStatus'] = ResolversParentTypes['MutationStatus'],
> = ResolversObject<{
...
export type PersonalUserResolvers<
	ContextType = GraphContext,
	ParentType extends
		ResolversParentTypes['PersonalUser'] = ResolversParentTypes['PersonalUser'],
> = ResolversObject<{
	account?: Resolver<
		Maybe<ResolversTypes['PersonalUserAccount']>,
		ParentType,
		ContextType
	>;
	createdAt?: Resolver<
...
export type PersonalUserAccountResolvers<
	ContextType = GraphContext,
	ParentType extends
		ResolversParentTypes['PersonalUserAccount'] = ResolversParentTypes['PersonalUserAccount'],
> = ResolversObject<{
	...
	profile?: Resolver<
		Maybe<ResolversTypes['PersonalUserAccountProfile']>,
		ParentType,
		ContextType
	>;
...
export type PersonalUserAccountProfileResolvers<
	ContextType = GraphContext,
	ParentType extends
		ResolversParentTypes['PersonalUserAccountProfile'] = ResolversParentTypes['PersonalUserAccountProfile'],
> = ResolversObject<{
	billing?: Resolver<
		Maybe<ResolversTypes['PersonalUserAccountProfileBilling']>,
		ParentType,
		ContextType
	>;
	firstName?: Resolver<
	...
	location?: Resolver<
		Maybe<ResolversTypes['PersonalUserAccountProfileLocation']>,
		ParentType,
		ContextType
	>;
	__isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type PersonalUserAccountProfileBillingResolvers<
	ContextType = GraphContext,
	ParentType extends
		ResolversParentTypes['PersonalUserAccountProfileBilling'] = ResolversParentTypes['PersonalUserAccountProfileBilling'],
> = ResolversObject<{
	cybersourceCustomerId?: Resolver<
		Maybe<ResolversTypes['String']>,
		ParentType,
		ContextType
	>;
...
export type PersonalUserAccountProfileLocationResolvers<
	ContextType = GraphContext,
	ParentType extends
		ResolversParentTypes['PersonalUserAccountProfileLocation'] = ResolversParentTypes['PersonalUserAccountProfileLocation'],
> = ResolversObject<{
...
> = ResolversObject<{
	...
	conversations?: Resolver<
		...
		ContextType
	>;
	currentPersonalUserAndCreateIfNotExists?: Resolver<
		ResolversTypes['PersonalUser'],
		ParentType,
		ContextType
	>;
	itemListing?: Resolver<
		Maybe<ResolversTypes['ItemListing']>,
		ParentType,
		ContextType,
		RequireFields<QueryItemListingArgs, 'id'>
	>;
	itemListings?: Resolver<
		Array<ResolversTypes['ItemListing']>,
		ParentType,
		ContextType
	>;
	...
	>;
	personalUserById?: Resolver<
		Maybe<ResolversTypes['PersonalUser']>,
		ParentType,
		ContextType,
		RequireFields<QueryPersonalUserByIdArgs, 'id'>
	>;
}>;
...
export type ReservationRequestResolvers<
	ContextType = GraphContext,
	ParentType extends
		ResolversParentTypes['ReservationRequest'] = ResolversParentTypes['ReservationRequest'],
> = ResolversObject<{
	closeRequestedByReserver?: Resolver<
		ResolversTypes['Boolean'],
		ParentType,
		ContextType
	>;
	closeRequestedBySharer?: Resolver<
		ResolversTypes['Boolean'],
		ParentType,
		ContextType
	>;
	...
	reservationPeriodEnd?: Resolver<
		ResolversTypes['String'],
		ParentType,
		ContextType
	>;
	reservationPeriodStart?: Resolver<
		ResolversTypes['String'],
		ParentType,
		ContextType
	>;
	...
	state?: Resolver<
		ResolversTypes['ReservationRequestState'],
		ParentType,
		ContextType
	>;
...
export type ReservationRequestMutationResultResolvers<
	ContextType = GraphContext,
	ParentType extends
		ResolversParentTypes['ReservationRequestMutationResult'] = ResolversParentTypes['ReservationRequestMutationResult'],
> = ResolversObject<{
	reservationRequest?: Resolver<
