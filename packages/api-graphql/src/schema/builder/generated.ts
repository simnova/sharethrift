...
> = ResolversObject<{
  ...
  personalUserUpdate?: Resolver<
    ResolversTypes["PersonalUser"],
    ParentType,
    ContextType,
    RequireFields<MutationPersonalUserUpdateArgs, "id" | "input">
  >;
}>;
...
> = ResolversObject<{
  ...
  currentEndUserAndCreateIfNotExists?: Resolver<ResolversTypes["PersonalUser"], ParentType, ContextType>;
  getUserConversations?: Resolver<
    Array<ResolversTypes["Conversation"]>,
    ParentType,
    ContextType,
    RequireFields<QueryGetUserConversationsArgs, "userId">
  >;
