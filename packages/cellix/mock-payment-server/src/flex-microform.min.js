...
!(function (e, t) {
	...
	return (function (e) {
		...
		function (e, t, n) {
			...
			function d(e) {
				return (
					'[object Number]' === Object.prototype.toString.call(e) && !isNaN(e)
				);
			}
			function E(e) {
				return 'object' ===
					...
					: u(e) && 1 === e.nodeType && 'string' == typeof e.nodeName;
			}
			function _(e) {
			...
			t.a = {
				...
				CREATE_FIELD_DUPLICATE: function (e) {
					return new o({
						...
						message: 'A "'.concat(
							e,
							'" field has already been created for this integration.',
						),
					});
				},
				...
				CREATE_TOKEN_XHR_ERROR: function () {
					return new o({
						...
						message:
							'Could not create a token as the underlying XMLHttpRequest failed.',
					});
				},
				...
				FIELD_UNLOAD_ERROR: function () {
					return new o({
						...
						message:
							'Field is not loaded. Call "load" before attempting to unload.',
					});
				},
				FIELD_ALREADY_LOADED: function () {
					return new o({
						...
						message:
							'Field has already been loaded. Call "unload" before trying to re-load.',
					});
				},
				FIELD_LOAD_CONTAINER_SELECTOR: function () {
					return new o({
						...
						message:
							'Unable to locate a DOM node using the supplied selector string.',
					});
				},
				FIELD_LOAD_INVALID_CONTAINER: function () {
					return new o({
						...
						message:
							'Invalid argument supplied to load. Supported values are [HTMLElement or a CSS selector string].',
					});
				},
				...
				MALFORMED_TOKENS_RESPONSE: function () {
					return new o({
						...
						message:
							'JWT returned on tokens request does not match expected format.',
					});
				},
				UNKNOWN_REASON: function (e) {
					return new o({
						...
						message:
							'Microform could not handle the recieved Flex API reason code.',
						details: e,
					});
				},
				...
				API_JWE_PARSING_ERROR: function () {
					return new o({
						...
						message:
							'Unable create a token as the JWE contents could not be parsed.',
					});
				},
				...
				CREATE_TOKEN_DECRYPTION: function () {
					return new o({
						...
						message:
							'Unable create a token as the JWE contents could not be decrypted.',
					});
				},
				CREATE_TOKEN_PLATFORM_ERROR: function () {
					return new o({
						...
						message:
							'There was a problem communicating with the tokenization service.',
					});
				},
				CREATE_TOKEN_CAPTURE_CONTEXT_USED_TOO_MANY_TIMES: function () {
					return new o({
						...
						message:
							'The supplied capture context has exceeded its usage limits. Please request another before trying again.',
					});
				},
				CREATE_TOKEN_CAPTURE_CONTEXT_NOT_FOUND: function () {
					return new o({
						...
						message:
							'The capture context could not be found. Please request another before trying again.',
					});
				},
				CREATE_TOKEN_NO_DATA_SUBMITTED: function () {
					return new o({
						...
						message:
							'At least one non-empty field must be supplied for tokenization.',
					});
				},
...
*/ var r = Object.getOwnPropertySymbols,
		...
		function (e, t, n) {
			...
			function i(e) {
				return new Error(
					'Required parameter "'.concat(e, '" was not supplied'),
				);
			}
			function a(e, t, n) {
				return new Error(
					'Invalid value of "'
						.concat(t, '" for "')
						.concat(e, '" parameter. Supported values are [')
						.concat(n.join(', '), ']'),
				);
			}
			function u(e, t, n) {
				return new Error(
					'Invalid value typeof "'
						.concat(t, '" supplied for parameter "')
						.concat(e, '". Expected typeof "')
						.concat(n, '".'),
				);
			}
			function c(e) {
				return new Error(
					'Failed expression evaluation for parameter "'.concat(e, '".'),
				);
			}
			function s(e) {
				var t =
				...
				return (
					Object.keys(t).forEach(function (s) {
						...
						if (
							Object(r.g)(f.expression) &&
							!0 !== f.expression.call(null, l, e, t)
						)
							throw c(s);
						n[s] = l;
					}),
		...
		function (e, t, n) {
			...
			function i(e, t, n) {
				...
				function s(e, t) {
					return (
						!(!Object(r.l)(e) || !Object(r.g)(t)) &&
						(i[e] || (i[e] = []), i[e].push(t), !0)
					);
				}
				function f(e, t) {
				...
				function d(e) {
					...
					if (
						(c === t || '*' === c) &&
						Object(r.j)(e.data) &&
						'application/x-telegram+json' === e.data.contentType &&
						'event' in e.data &&
						!(
							!'application/x-telegram+json'.indexOf(e.data.event) < 0 ||
							(void 0 !== e.data.channel &&
								e.data.channel !== a &&
								'*' !== e.data.channel)
						)
					) {
				...
				return (
					window.addEventListener('message', d, !1),
					{
						publish: function (e, t, n) {
							var r = l(e, t, n);
							try {
								(u instanceof HTMLIFrameElement
									? u.contentWindow
									: u
								).postMessage(r, c);
							} catch (e) {
		...
		function (e, t, n) {
			...
			function d() {
				...
				return {
					subscribe: function (t, n) {
						...
						return (
							e.hasOwnProperty.call(e, t) || (e[t] = []), e[t].push(n), this
						);
					},
			...
			var b = Object.keys(_).map(function (e) {
				...
				T = s()({}, O, {
					maxLength: { type: 'number', required: !1, supportedValues: [3, 4] },
				}),
				g = Object.keys(f).map(function (e) {
					return f[e];
				}),
				y = '/microform/bundle/v'.concat('1.0.3', '/iframe.html');
			function v(e, t, n, r, o, i) {
				...
				void 0 === document.location.ancestorOrigins &&
					(a.refererOrigin = window.location.origin);
				var u = document.createElement('iframe');
				return (
					u.setAttribute('hspace', '0'),
					...
					u.setAttribute('title', 'secure payment field'),
				...
				t.subscribe(f.LOAD, function (e) {
					...
					t.subscribe(f.BLUR, function (e) {
						!(function (e, t) {
							if (
								t &&
								('next' === t.focusShift || 'previous' === t.focusShift)
							) {
								var n = Array.prototype.slice
										...
										.filter(function (e) {
											...
											return (
												(!t || parseInt(t, 10) >= 0) &&
												((n.width > 0 && n.height > 0) || 'AREA' === e.tagName)
											);
										}),
					...
					t.subscribe(f.CHANGE, function (e) {
						e.valid
							? (r.parentElement.classList.remove(_.invalid),
								r.parentElement.classList.add(_.valid))
							: e.couldBeValid
								? (r.parentElement.classList.remove(_.invalid),
									r.parentElement.classList.remove(_.valid))
								: (r.parentElement.classList.remove(_.valid),
					...
					t.subscribe(f.UPDATE, function (e) {
						s()(u._config, e),
							!0 === e.disabled
								? r.parentElement.classList.add(_.disabled)
								: r.parentElement.classList.remove(_.disabled),
							I(n, f.UPDATE, e);
					}),
					...
					e === i.NUMBER &&
						(t.subscribe(f.AUTOCOMPLETE, function (e) {
			...
			var L = (function () {
				function e(t, n, i, a) {
					...
					(this._iframe = v(t, n, c, a, this._config, i)),
						...
						(this._loaded = !1),
						N.call(this, i, this._telegram, this._pubSub, this._iframe);
				}
				var t, n, i;
				return (
					(t = e),
					(n = [
						...
						},
						{
							...
							value: function (e) {
								...
								if (e instanceof Element) this._container = e;
								else {
									if ('string' != typeof e)
								...
								for (
									this._iframe.setAttribute('src', o);
			...
			var C = Object.keys(i).map(function (e) {
				...
				j = { styles: { type: 'object', required: !1, default: {} } },
				x = (function () {
					function e(t) {
						var n =
							arguments.length > 1 && void 0 !== arguments[1]
						...
						D(this, e),
							...
							(this._flexConfig = t),
							(this._baseConfig = { styles: n.styles }),
							(this.fields = {});
					}
					var t, n, i;
					return (
								...
								value: function (e, t) {
									var n = this,
										...
										u = Object.keys(this.fields).reduce(function (e, t) {
											return (
												n.fields[t]._loaded &&
													(i.push(t), e.push(n.fields[t]._telegram.publish)),
												e
											);
										}, []);
									if (u.length < 1) t(r.a.CREATE_TOKEN_NO_FIELDS_LOADED());
									else {
										Object(o.o)(u);
										for (
											var c = {
													options: Object(o.v)(e, [
														'type',
														'expirationMonth',
														'expirationYear',
													]),
					...
					!(function (e, t) {
						...
						(this._config = (function (e) {
							...
							try {
								...
								if (
									!(t = JSON.parse(Object(o.t)(e.split('.')[1]))).jti ||
									!t.flx.origin
								)
									throw new Error();
							} catch (e) {
