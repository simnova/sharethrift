# @cellix/mock-oauth2-server-seedwork
...
```typescript
import { startMockOAuth2Server, type OAuth2Config } from '@cellix/mock-oauth2-server-seedwork';
import { setupEnvironment } from '@cellix/mock-oauth2-server-seedwork/setup-environment';
