# @cellix/service-messaging-mock

Mock implementation of the messaging service interface for local development and testing.

## Purpose

HTTP client that communicates with `@apps/server-messaging-mock`, eliminating the need for real messaging provider credentials during development.
...
- `@apps/server-messaging-mock` - The HTTP server this client connects to
- `@cellix/service-messaging-twilio` - Production Twilio implementation
